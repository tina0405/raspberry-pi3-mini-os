...
void sys_mutex_trylock(struct thread_mutex *mutex){
	thread_mutex_trylock(mutex);
}

void sys_mutex_lock(struct thread_mutex *mutex){
	thread_mutex_lock(mutex);
}

void sys_mutex_unlock(struct thread_mutex *mutex){
...
void * const sys_call_table[] = {sys_write, sys_fork, sys_exit, sys_led, sys_read, sys_write_int, /*0-5*/ 
				...
				sys_recieve_msg,sys_mutex_trylock,sys_mutex_lock,sys_mutex_unlock};
